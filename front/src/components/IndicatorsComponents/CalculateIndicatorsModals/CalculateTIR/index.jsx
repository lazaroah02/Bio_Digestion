...
function CalculateTIR({indicators, setTIRResult}) {
    ...
    return ( 
        <form className='calculate-indicator-form calculate-TIR-form' onSubmit={(e) => handleCalculate(e)}>
            <div>
            ...
            <IndicatorFormActionButtons handleCleanResult={handleCleanResult} key = {"TIR"}/>
        </form>
    );
}
